...
#endif	//defined(ITF_GROUP) || defined(NEW_PORTMAPPING)
...
XML_ENTRY_PRIMITIVE2("Sid", sid, atmvc, "%hhu", (atmvc+atmvc_Idx)->sid, 0);	 //BYTE_T
#endif
...
XML_ENTRY_STRING2("FilterMode", action, macfilter, (macfilter+macfilter_Idx)->action, 0);   //STRING_T
...
XML_ENTRY_STRING2("Value", value, dhcpopt_server, (dhcpopt_server+dhcpopt_server_Idx)->value, 0);   //STRING_T
...
XML_ENTRY_STRING2("Value", value, dhcpopt_client, (dhcpopt_client+dhcpopt_client_Idx)->value, 0);   //STRING_T
...
XML_ENTRY_PRIMITIVE2("EgressTag", egressTagAction, swport, "%hhu", (swport+swport_Idx)->egressTagAction, 0);   //BYTE_T
...
XML_ENTRY_PRIMITIVE2("Srcip", srcip, ipqos_tc, "%u", (ipqos_tc+ipqos_tc_Idx)->srcip, 0);   //DWORD_T
XML_ENTRY_PRIMITIVE2("srcmask", smaskbits, ipqos_tc, "%hhu", (ipqos_tc+ipqos_tc_Idx)->smaskbits, 0);   //BYTE_T
XML_ENTRY_PRIMITIVE2("dstip", dstip, ipqos_tc, "%u", (ipqos_tc+ipqos_tc_Idx)->dstip, 0);   //DWORD_T
...
XML_ENTRY_PRIMITIVE2("outif", outif, ipqos_queue, "%u", (ipqos_queue+ipqos_queue_Idx)->outif, 0);   //INTEGER_T
...
XML_ENTRY_STRING2("ipAddr", ipAddr_Dhcp, macBaseDhcp, (macBaseDhcp+macBaseDhcp_Idx)->ipAddr_Dhcp, 0);   //STRING_T
...
XML_ENTRY_PRIMITIVE2("IfIndex", fixedTxRate, mbssid, "%d", (mbssid+mbssid_Idx)->fixedTxRate, 0);   //INTEGER_T
...
XML_ENTRY_PRIMITIVE2("IfIndex", fixedTxRate, wlan1_mbssid, "%d", (wlan1_mbssid+wlan1_mbssid_Idx)->fixedTxRate, 0);   //INTEGER_T
#ifdef CONFIG_USB_RTL8187SU_SOFTAP
...
#if defined(CONFIG_RTL_92D_SUPPORT) || defined(WLAN_DUALBAND_CONCURRENT)
	{MIB_WLAN1_AC_TBL, _wlac, sizeof(MIB_CE_WLAN_AC_T)},
#endif
#endif
#endif
