...
extern struct universe ctcom_universe;
#endif
...
// Mason Yu. for EUI64 format			   
isc_result_t create_lease6_2(struct ipv6_pool *pool,
			   struct iasubopt **addr,
			   unsigned int *attempts,
			   const struct data_string *uid,
			   time_t soft_lifetime_end_time, struct packet *packet);
