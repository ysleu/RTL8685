...
<title><% multilang("Port Mapping"); %><% multilang(" Configuration"); %></title>
<SCRIPT>
function adminClick()
{
...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang("Port Mapping"); %><% multilang(" Configuration"); %></font></h2>

<form action=/boaform/formVlanGroup method=POST name="eth2pvc">
<table border=0 width="700" cellspacing=4 cellpadding=0>
  <tr><font size=2>
    <% multilang("To manipulate a mapping group"); %>:<br>
    <b>1.</b> <% multilang("Select a group from the table."); %><br>
    <b>2.</b> <% multilang("Select interfaces from the available/grouped interface list and add it to the grouped/available interface list using the arrow buttons to manipulate the required mapping of the ports."); %><br>
    <b>3.</b> <% multilang("Click 'Apply Changes' button to save the changes."); %><br><br>
    <b><% multilang("Note that the selected interfaces will be removed from their existing groups and added to the new group."); %></b>
  </tr>
  <tr><td><hr size=1 noshade align=top></td></tr>
</table>
<table>
      <input type="radio" name=pmap value=0 onClick="return adminClick()"><% multilang("Disabled"); %>&nbsp;&nbsp;
      <input type="radio" name=pmap value=1 onClick="return adminClick()"><% multilang("Enabled"); %></td>
</table><br>
<table border="0" cellpadding="0" cellspacing="0">
   <tr>
      <td width="150"><font size=2><b><% multilang("Grouped Interfaces"); %></b></td>
      <td width="100"></td>
      <td width="150"><font size=2><b><% multilang("Available Interfaces"); %></b></td>
   </tr>
   <!--
...
<table border='0' width=700>
  ...
  <br>
      ...
      <input type=submit value="<% multilang("Apply Changes"); %>" name="save" onClick=btnApply()>&nbsp;&nbsp;
