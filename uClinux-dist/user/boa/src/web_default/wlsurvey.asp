...
<title><% multilang("WLAN Site Survey"); %></title>
...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang("WLAN Site Survey"); %></font></h2>

<table border=0 width="500" cellspacing=0 cellpadding=0>
<tr><td><font size=2>
 <% multilang("This page provides tool to scan the wireless network. If any Access Point or IBSS is found, you could choose to connect it manually when client mode is enabled."); %>
</font></td></tr>
...
<br>
  ...
  <input type="button" value="<% multilang("Next Step"); %>" name="next" onClick="saveClickSSID()">
</span>
...
<table border=0 width="500" cellspacing=4 cellpadding=0>
    	...
    	<td colspan="2" width="100%">			
    		<table width="100%" border="0" cellpadding="0" cellspacing="4">
    		 	<tr>	
    				...
    				<td width="70%" class="bggrey"><font size="2">
    					<input name="auth_type" type=radio value="open" checked><% multilang("Open System"); %>
  ...
  <br>
  <input type="button" value="<% multilang("Back"); %>" name="back" onClick="return backClick()">
  <input type="submit" value="<% multilang("Connect"); %>" name="connect" onClick="return connectClick()">
  </span>
