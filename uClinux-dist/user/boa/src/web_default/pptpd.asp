...
function addPptpAccount()
{
	...
	if (document.pptp.s_name.value=="") {
		alert("Please enter PPTP Server rule name!");
	...
	{
		alert("Please enter pptp Server username !");
	...
	if (document.pptp.s_password.value=="") {
		alert("Please enter pptp Server password!");
...
function addPptpClient()
{
	...
	if (document.pptp.c_name.value=="") {
		alert("Please enter PPTP client rule name!");
		document.pptp.c_name.focus();
		return false;
	}
