...
<title><% multilang("Port Forwarding"); %></title>
...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang("Port Forwarding"); %></font></h2>

<table border=0 width="500" cellspacing=0 cellpadding=0>
<tr><td><font size=2>
 <% multilang("Entries in this table allow you to automatically redirect common network services to a specific machine behind the NAT firewall. These settings are only necessary if you wish to host some sort of server like a web server or mail server on the private local network behind your Gateway's NAT firewall."); %>
</font></td></tr>
...
<tr><td><font size=2><b><% multilang("Port Forwarding"); %>:</b>
	<input type="radio" value="0" name="portFwcap" <% checkWrite("portFw-cap0"); %> onClick="updateState()"><% multilang("Disable"); %>&nbsp;&nbsp;
	<input type="radio" value="1" name="portFwcap" <% checkWrite("portFw-cap1"); %> onClick="updateState()"><% multilang("Enable"); %>&nbsp;&nbsp;
...
<table border=0 width="500" cellspacing=0 cellpadding=0>
    <tr>
		<td>
			<font size=2><b><% multilang("Comment"); %>
		</td>
		<td>
			<font size=2><b><% multilang("Local IP"); %>
		</td>
		<td>
			<font size=2><b><% multilang("Local Port from"); %>
		</td>
		<td>
			<font size=2><b><% multilang("Local Port to"); %>
		</td>
		<td>
			<font size=2><b><% multilang("Protocol"); %>
		</td>
 	<td <% checkWrite("rg_hidden_function"); %>>
			<font size=2><b><% multilang("Remote IP"); %>
		</td>
 	<td>
			<font size=2><b><% multilang("Remote Port from"); %>
		</td>
 	<td>
			<font size=2><b><% multilang("Remote Port to"); %>
		</td>
 	<td>
			<font size=2><b><% multilang("Interface"); %> </b><br>
		</td>
    </tr>
	...
	<tr>
		<td>
			<input type="submit" value="<% multilang("Add"); %>" name="addPortFw" onClick="return addClick()">
...
<form action=/boaform/formPortFw method=POST name="formPortFwDel">
	<table border=0 width=500>
		<tr><font size=2><b><% multilang("Current Port Forwarding Table"); %>:</b></font></tr>
		<% portFwList(); %>
	</table>
