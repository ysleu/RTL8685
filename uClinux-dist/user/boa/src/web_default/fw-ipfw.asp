...
<title><% multilang("NAT IP Forwarding"); %></title>
...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang("NAT IP Forwarding"); %></font></h2>

<table border=0 width="500" cellspacing=4 cellpadding=0>
<tr><td><font size=2>
 <% multilang("Entries in this table allow you to automatically redirect traffic to a specific machine behind the NAT firewall. These settings are only necessary if you wish to host some sort of server like a web server or mail server on the private local network behind your Gateway's NAT firewall."); %>
</font></td></tr>
...
<tr><td><font size=2><b>
   	<input type="checkbox" name="enabled" value="ON" <% checkWrite("ipFwEn"); %>
   	 ONCLICK=updateState()>&nbsp;&nbsp;<% multilang("Enable"); %> <% multilang("NAT IP Forwarding"); %></b><br>
    </td>
</tr>

<tr><td>
    <font size=2><b><% multilang("Local"); %> <% multilang("IP Address"); %>:</b> <input type="text" name="l_ip" size="10" maxlength="15"></td>
</tr>
<tr><td>
    <font size=2><b><% multilang("External"); %> <% multilang("IP Address"); %>:</b> <input type="text" name="r_ip" size="10" maxlength="15"></td>
</tr>
<tr><td>
  <input type="submit" value="<% multilang("Apply Changes"); %>" name="addEntry" onClick="return addClick()">&nbsp;&nbsp;
...
<table border=0 width=500>
  <tr><font size=2><b><% multilang("Current NAT IP Forwarding Table"); %>:</b></font></tr>
  <% ipFwList(); %>
</table>

 <br><input type="submit" value="<% multilang("Delete Selected"); %>" name="delSelEntry" onClick="return deleteClick()">&nbsp;&nbsp;
     <input type="submit" value="<% multilang("Delete All"); %>" name="delAllEntry" onClick="return deleteAllClick()">&nbsp;&nbsp;&nbsp;
