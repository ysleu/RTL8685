...
<tr><td><font size=2>
 <% multilang("Entries in this table are used to assign the precedence for each incoming packet. If disable IP QoS, traffic shaping will be effective, otherwise traffic shaping is invalid."); %>
</font></td></tr>
</table>
...
<tr>
	...
	<td width=60%>
		<input type="radio" name=qosen value=0 onClick="return adminClick()"><font size=2><% multilang("Disabled"); %>&nbsp;&nbsp;
		<input type="radio" name=qosen value=1 onClick="return adminClick()"><font size=2><% multilang("Enabled"); %>
	</td>
</tr>
<tr>
	<td width=20%><font size=2><% multilang("Policy"); %>:</td>
	<td width=60%>
...
<td colspan="2"><hr size=1 width=600 noshade align=left></td>
<table border=0 width=600 cellspacing=0 cellpadding=0>
<tr><td colspan="2"><th colspan=4><u><% multilang("Specify Traffic Classification Rules"); %></u></th></td></tr>
</table>

<table border=0 width=600 cellspacing=0 cellpadding=0>
<!--<tr><td colSpan="2"><b>SET-1</b></td></tr>-->
<tr>
	<td width="200px"><% multilang("Protocol"); %>:</td>
...
<tr><td><% multilang("Source"); %> IP:</td><td><input type=text name=sip size=20 maxlength=15 onChange="onchange_sel1();"></td></tr>
<tr><td><% multilang("Source Mask"); %>:</td><td><input type=text name=smask size=20 maxlength=15 onChange="onchange_sel1();"></td></tr>
<tr><td><% multilang("Source Port"); %>:</td><td><input type=text name=sport size=10 maxlength=5 onChange="onchange_sel1();"></td></tr>
<tr><td><% multilang("Destination"); %> IP:</td><td><input type=text name=dip size=20 maxlength=15 onChange="onchange_sel1();"></td></tr>
<tr><td><% multilang("Destination Mask"); %>:</td><td><input type=text name=dmask size=20 maxlength=15 onChange="onchange_sel1();"></td></tr>
<tr><td><% multilang("Destination Port"); %>:</td><td><input type=text name=dport size=10 maxlength=5 onChange="onchange_sel1();"></td></tr>
	<td><% multilang("Physical Port"); %>:</td>
...
<td colspan="2"><hr size=1 width=600 noshade align=left></td>
<table border=0 width=600 cellspacing=0 cellpadding=0>
<tr><td colspan="2"><th colspan=4><u><% multilang("Assign Priority and/or IP Precedence and/or Type of Service and/or DSCP"); %></u></th></td></tr>
</table>
<table border=0 width=600 cellspacing=0 cellpadding=0>
<tr><td width="200px "><font size=2><% multilang("Outbound Priority"); %>:</td>
	<td>
		<% pq_egress(); %>
	</td>
</tr>
