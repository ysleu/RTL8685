...
<title>IP <% multilang("QoS Queue"); %></title>
...
<body>
<blockquote>
<h2><font color="#0000FF">IP <% multilang("QoS Queue"); %></font></h2>

<table id=box_header border=0 width=600 cellSpacing=0>
<tr><td colspan=4><font size=2>
IP <% multilang("QoS Queue"); %><% multilang(" Configuration"); %>
</font></td></tr>
...
<table id=body_header border=0 width=600>
	<tr><td width=100% colspan=7><font size=2><b><% multilang("Queue Config List"); %></b></font></td></tr>
...
<input type='button' onClick='addClick()' value='<% multilang("Add"); %>'>
<!--
		...
		<tr>
			<td>
	                    <table border="0" cellpadding="0" cellspacing="0" width=100%>
	                           <tr>
                                      <td width=30%><% multilang("Queue Description"); %>&nbsp;:</td>
                                      <td width=70%><input type="text" name="queuedesc" size="16" maxlength="30" readonly>                                                     
                                      </td>
                                   </tr>
                                   
                                   <tr>
                                      <td width=30%><% multilang("Queue Status"); %>&nbsp;:</td>
                                      <td width=70%>
                                         <select name='queueenbl' size="1">
                                            <option value="0">(<% multilang("Click to Select"); %>)
                                            <option value="1"> <% multilang("Disable"); %>
                                            <option value="2"> <% multilang("Enable"); %>
                                         </select>
                                      </td>
                                   </tr>
                                   
                                   <tr>
                                      <td width=30%><% multilang("Queue Interface"); %>&nbsp;:</td>
					  ...
					  <% if_wan_list("queueITF"); %>                  
                                   ...
                                   <tr>
                                      <td width=30%><% multilang("Queue Priority"); %>&nbsp;:</td>
                                      <td width=70%>
         ...
         <br>
<input type='submit' onClick='return btnApply()' value='<% multilang("Apply"); %>' name="save"><input type='button' onClick='return btnCancel()' value='<% multilang("Cancel"); %>'>
</div>
