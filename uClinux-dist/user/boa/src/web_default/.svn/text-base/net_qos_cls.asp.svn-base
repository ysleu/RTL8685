<HTML>
<HEAD>
<TITLE>QoS <% multilang("Classification"); %></TITLE>
	...
	<blockquote>
		<DIV align="left" style="padding-left:20px; padding-top:5px;">
			<form id="form" action="/boaform/admin/formQosRule" method="post">
				<h2><font color="#0000FF">QoS <% multilang("Classification"); %></font></h2>				
				<div class="tip" style="width:90% ">
					<% multilang("This page is used to add or delete classicification rule."); %><font color="red">(<% multilang("After add a new rule, please click 'Apply Changes' to take effect."); %>)</font>
				</div>
				...
				<table class="flat" id="lstrc" border="1" cellpadding="0" cellspacing="1">
				   <tr class="hdb" align="center" nowrap bgcolor="#CCCCCC"><font size=2>
						<td colspan="2">&nbsp;</td>
						<td colspan="3"><b><% multilang("Mark"); %></b></td>
						<td colspan="3" width="300"><b><% multilang("Classification Rules"); %></b></td>
						<td colspan="2">&nbsp;</td>
					</tr>
					<strong>
				   <tr class="hdb" align="center" nowrap>
						<td><font size=2><% multilang("ID"); %></td>
						<td><font size=2><% multilang("Name"); %></td>
						<td><font size=2><% multilang("VLAN ID"); %></td>
						<td><font size=2>DSCP <% multilang("Mark"); %></td>
						<td><font size=2><% multilang("802.1p"); %></td>
						               
						<td><font size=2> <% multilang("Queue"); %></td>
						<td><font size=2> <% multilang("WanIf"); %></td>
						<td><font size=2 width="280"><% multilang("Rule Detail"); %></td>					
						<td><font size=2><% multilang("Delete"); %></td>
						<td><font size=2><% multilang("Edit"); %></td>
						
					</tr>
					</strong>
				</table>
				<br>
				<input type="button" class="button" onClick="location.href='net_qos_cls_edit.asp';" value="<% multilang("Add"); %>">
