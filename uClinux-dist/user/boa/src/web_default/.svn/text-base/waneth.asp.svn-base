...
<title><% multilang("Ethernet WAN"); %></title>
...
<BODY>
<blockquote>
<h2><font color="#0000FF"><% multilang("Ethernet WAN"); %></font></h2>
<form action=/boaform/admin/formWanEth method=POST name="ethwan">
<table border="0" cellspacing="4" width="800">
 <tr><td><font size=2>
    <% multilang("This page is used to configure the parameters for Ethernet WAN of your Router."); %>
  </font></td></tr>
