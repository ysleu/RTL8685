...
<title><% multilang("WLAN Security Settings"); %></title>
...
function check_wepkey()
{
	...
	if (form.key0.value.length != keyLen) {
		alert('Invalid length of Key value. It should be ' + keyLen + ' characters.');
		form.key0.focus();
		return 0;
	}
	if ( form.key0.value == "*****" ||
...
function saveChanges()
{
  ...
  if (form.security_method.value == 0) {	/* WIFI_SEC_NONE */
    ...
    if (form.security_method.value == 2) {	/* WIFI_SEC_WPA */
		...
		{
			alert("Can't select TKIP and AES in the same time.");
			return false;				
		}
		if (wps20 && wps20_use_version!=0 && form.wpaSSID.value==0)
...
function postSecurity(encrypt, enable1X, wpaAuth, wpaPSKFormat, wpaPSK, rsPort, rsIpAddr, rsPassword, uCipher, wpa2uCipher, wepAuth, wepLen, wepKeyFormat, dotIeee80211w, sh256) 
{	
...
<blockquote>
<h2><font color="#0000FF"><% multilang("WLAN Security Settings"); %></font></h2>

<form action=/boaform/admin/formWlEncrypt method=POST name="formEncrypt">
<table border=0 width="500" cellspacing=4 cellpadding=0>
    <tr><td><font size=2>
    <% multilang("This page allows you setup the WLAN security. Turn on WEP or WPA by using Encryption Keys could prevent any unauthorized access to your wireless network."); %>
    </font></td></tr>
...
<table border=0 width="500" cellspacing=4 cellpadding=0>
    ...
    <tr>
      <td width="35%"><font size="2"><b><% multilang("Encryption"); %>:&nbsp;</b>        
    ...
    <tr id="enable_8021x" style="display:none">
  	<td colspan="2" width="100%">			
  		<table width="100%" border="0" cellpadding="0" cellspacing="4">
  		 	<tr>
  				 <td width="30%" class="bgblue"><font size="2"><b>802.1x <% multilang("Authentication"); %>:</b></font></td>
    ...
    <tr id="show_wep_auth" style="display:none">
    	<td colspan="2" width="100%">			
    		<table width="100%" border="0" cellpadding="0" cellspacing="4">
    		 	<tr>	
    				<td width="30%"bgcolor="#FFFFFF" class="bgblue"><font size="2"><b><% multilang("Authentication"); %>:</b></font></td>
    				<td width="70%" class="bggrey"><font size="2">
    					<input name="auth_type" type=radio value="open"><% multilang("Open System"); %>
    					<input name="auth_type" type=radio value="shared"><% multilang("Shared Key"); %>
    					<input name="auth_type" type=radio value="both"><% multilang("Auto"); %>
    						</font>
    			</td></tr>
    		</table>
    </td></tr>	
    ...
    <tr id="setting_wep" style="display:none">	
		<td colspan="2" width="100%">			
			<table width="100%" border="0" cellpadding="0" cellspacing="4">
			 	...
			 	<tr bgcolor="#FFFFFF">
					<td width="30%" bgcolor="#FFFFFF" class="bgblue"><font size="2"><b><% multilang("Key Length"); %>:</b></font></td>
					<td width="70%" class="bggrey"><font size="2">
				...
				<tr bgcolor="#FFFFFF">
					<td width="30%" bgcolor="#FFFFFF" class="bgblue"><font size="2"><b><% multilang("Key Format"); %>:</b></font></td>
				...
				<tr bgcolor="#FFFFFF">
					<td width="30%" bgcolor="#FFFFFF" class="bgblue"><font size="2"><b><% multilang("Encryption Key"); %>:</b></font></td>
					<td width="70%" class="bggrey">
	...
	<tr id="setting_wpa" style="display:none">
		<td colspan="2">	
			<table width="100%" border="0" cellpadding="0" cellspacing="4">			
				<tr>
					<td width="30%" class="bgblue"><font size="2"><b><% multilang("Authentication Mode"); %>:</b></font></td>
					<td width="70%" class="bggrey"><font size="2">
				...
				<tr id="show_dotIEEE80211W" style="display:none">
					<td width="30%" class="bgblue"><font size="2"><b><% multilang("IEEE 802.11w"); %>:</b></font></td>
					<td width="70%" class="bggrey"><font size="2">
				...
				<tr id="show_sha256" style="display:none">
					<td width="30%" class="bgblue"><font size="2"><b><% multilang("SHA256"); %>:</b></font></td>
					<td width="70%" class="bggrey"><font size="2">
				...
				<tr id="show_wpa_cipher" style="display:none">
					<td width="30%" class="bgblue"><font size="2"><b>WPA <% multilang("Cipher Suite"); %>:</b></font></td>
					<td width="70%" class="bggrey"><font size="2">
				...
				<tr id="show_wpa2_cipher" style="display:none">
					<td width="30%"class="bgblue"><font size="2"><b>WPA2 <% multilang("Cipher Suite"); %>:</b></font></td>
					<td width="70%" class="bggrey"><font size="2">
				...
				<tr id="show_wpa_psk1" style="display:none">				
					<td width="30%" bgcolor="#FFFFFF" class="bgblue"><font size="2"><b><% multilang("Pre-Shared Key Format"); %>:</b></font></td>
					<td width="70%" class="bggrey">
				...
				<tr id="show_wpa_psk2" style="display:none">
					<td width="30%" bgcolor="#FFFFFF" class="bgblue"><font size="2"><b><% multilang("Pre-Shared Key"); %>:</b></font></td>
	...
	<tr id="show_1x_wep" style="display:none">
		<td colspan="2">	
			<table width="100%" border="0" cellpadding="0" cellspacing="4">			
				<tr>	
					<td width="30%" class="bgblue"><font size="2"><b><% multilang("Key Length"); %>:</b></font></td>
					<td width="70%" class="bggrey"><font size="2">
	...
	<tr id="show_8021x_eap" style="display:none">
		<td colspan="2">			
			<table width="100%" border="0" cellpadding="0" cellspacing="4"> 
				<tr>
					 <td width="30%" bgcolor="#FFFFFF" class="bgblue"><font size="2"><b>RADIUS <% multilang("Server"); %> <% multilang("IP Address"); %>:</b></font></td>
					 <td width="70%" bgcolor="#FFFFFF" class="bggrey"><input id="radius_ip" name="radiusIP" size="16" maxlength="15" value="0.0.0.0"></td>
				 </tr>
				<tr>
					<td width="30%" bgcolor="#FFFFFF" class="bgblue"><font size="2"><b>RADIUS <% multilang("Server"); %> <% multilang("Port"); %>:</b></font></td>
					<td width="70%" class="bggrey"><input type="text" id="radius_port" name="radiusPort" size="5" maxlength="5" value="1812"></td>
				 </tr>
				<tr>
					<td width="30%" class="bgblue"><font size="2"><b>RADIUS <% multilang("Server"); %> <% multilang("Password"); %>:</b></font></td>
        ...
        <tr id="show_8021x_wapi" style="display:none">
                <td colspan="2">
                        <table width="100%" border="0" cellpadding="0" cellspacing="4">
                                ...
                                <td width="30%" class="bgblue"><font size="2"><b><% multilang("Use Local AS Server"); %>:</b></font></td>
                                <td width="70%" class="bggrey"><font size="2">
                                <input type="checkbox" id="uselocalAS" name="uselocalAS" value="ON" onClick="show_wapi_ASip()">
                                </font>
                                </td></tr>
				<tr>
                                         <td width="30%" bgcolor="#FFFFFF" class="bgblue"><font size="2"><b>AS <% multilang("Server"); %> <% multilang("IP Address"); %>:</b></font></td>
