...
<title><% multilang("System Date & Time Modification"); %></title>
</head>

<body>
<blockquote>
<h2><font color="#0000FF"><% multilang("System Date & Time Modification"); %></font></h2>

<table border=0 width="480" cellspacing=0 cellpadding=0>
  <tr><td><font size=2>
    <% multilang("Set the system date and time."); %>
  </font></td></tr>
...
<table border='1' width="80%">
  <tr>
      <td width=30%><font size=2><b><% multilang("Date"); %>:</b></td>
      <td width=70%>
  ...
  <tr>
      <td width=30%><font size=2><b><% multilang("Time"); %>:</b></td>
      <td width=70%>
  ...
  <tr>
      <td width=30%><font size=2><b><% multilang("Time Zone"); %>:</b></td>
      <td width=70%>
      	<select name="sys_tz">
...
<input type="hidden" value="/admin/date.asp" name="submit-url">
  <p><input type="submit" value="<% multilang("Submit"); %>" name="set">&nbsp;&nbsp;
  <input type="button" value="<% multilang("Cancel"); %>" name="close" onClick="javascript: window.close();"></p>
</form>
</blockquote>
</body>
