...
<title><% multilang("ATM Settings"); %></title>
...
<BODY>
<blockquote>
<h2><font color="#0000FF"><% multilang("ATM Settings"); %></font></h2>

<table border=0 width="500" cellspacing=4 cellpadding=0>
<tr><td><font size=2>
    <% multilang("This page is used to configure the parameters for the ATM of your Router. Here you may change the setting for VPI, VCI, QoS etc ..."); %>
</font></td></tr>
...
<tr><td>
	...
	<p><input type="submit" value="<% multilang("Apply Changes"); %>" name="changeAtmVc" onClick="return addClick()">&nbsp;&nbsp;
		<input type="reset" value="<% multilang("Undo"); %>" name="reset" onClick="resetClicked()">
