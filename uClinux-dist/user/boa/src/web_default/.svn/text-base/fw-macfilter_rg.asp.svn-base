...
<tr>
	...
	<select name=dir>
		...
		<option value=1><% multilang("Source"); %></option>
		<option value=2><% multilang("Destination"); %></option>
	</select>
	</td>
</tr>
<tr>
	<td><font size=2>
	<b><% multilang("MAC Address"); %>: </b></font>
	</td>
	<td>
