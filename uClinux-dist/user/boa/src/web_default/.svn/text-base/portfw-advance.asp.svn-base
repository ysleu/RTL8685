...
<title><% multilang("Port Forwarding"); %> - <% multilang("Advanced Setting"); %></title>
...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang("Port Forwarding"); %> - <% multilang("Advanced Setting"); %></font></h2>

<form action=/boaform/formPFWAdvance method=POST name="portfwAdvance">
   <table border=0 width="500" cellspacing=4 cellpadding=0>
      <hr size=2 noshade align=top>
      <tr>
          <td><font size=2><b><% multilang("Category"); %>: </b>
              <input type="radio" name=gategory value=0 onClick="postPFW('', '', 'PPTP,L2TP', '0,1')"><% multilang("VPN"); %>&nbsp;&nbsp;  
          </td>
      </tr>   
   </table>  
   ...
   <table border=0 width="500" cellspacing=4 cellpadding=0>
      <hr size=2 noshade align=top>
      <tr>
       <td><font size=2><b><% multilang("Interface"); %>:</b> 
   ...
   <table border=0 width="500" cellspacing=4 cellpadding=0>
      <hr size=2 noshade align=top>
      <tr>      
         <td width="150"><font size=2><b><% multilang("Available Rules"); %></b></td>
         <td width="100"></td>
         <td width="150"><font size=2><b><% multilang("Applied Rules"); %></b></td>
      </tr>      
    ...
    <tr>
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;      
      <input type=submit value="<% multilang("Add"); %>" name="save" onClick="return PFWApply()">&nbsp;&nbsp;
    </tr>      
      
   <table border=0 width="500" cellspacing=4 cellpadding=0>
    <tr><hr size=1 noshade align=top></tr>
    <tr><font size=2><b><% multilang("Port Forwarding Advance Table"); %>:</b></font></tr>
    <% showPFWAdvTable(); %>
   </table>
   ...
   <input type="submit" value="<% multilang("Delete Selected"); %>" name="delRule">&nbsp;&nbsp;  
   <input type="submit" value="<% multilang("Delete All"); %>" name="delAllRule" onClick="return deleteAllClick()">&nbsp;&nbsp;&nbsp;
