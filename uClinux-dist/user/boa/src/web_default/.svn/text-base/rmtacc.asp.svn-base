...
<title><% multilang("Remote Access"); %><% multilang(" Configuration"); %></title>
...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang("Remote Access"); %><% multilang(" Configuration"); %></font></h2>

<table border=0 width=500 cellspacing=4 cellpadding=0>
<tr><td colspan=4><font size=2>
 <% multilang("This page is used to enable/disable management services for the LAN and WAN."); %>
</font></td></tr>
...
<tr>
	<td width=150 align=left><font size=2><b><% multilang("Service"); %><% multilang(" Name"); %></b></td>
	<td width=80 align=center><font size=2><b><% multilang("LAN"); %></b></td>
	<td width=80 align=center><font size=2><b><% multilang("WAN"); %></b></td>
	<td width=80 align=center><font size=2><b><% multilang("WAN Port"); %></b></td>
</tr>
<% rmtaccItem(); %>
</table>
<br>
<tr>
	<td><input type="submit" value="<% multilang("Apply Changes"); %>" name="set" onClick="return addClick()"></td>
