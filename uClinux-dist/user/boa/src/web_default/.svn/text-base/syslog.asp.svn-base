...
<title><% multilang("System Log"); %></title>
...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang("System Log"); %></font></h2>
<form action=/boaform/formSysLog method=POST name=formSysLog>
<table border="0" cellspacing="4" width="500">
<tr><hr size=1 noshade align=top></tr>
<tr>
	<td width="25%"><font size=2><b><% multilang("System Log"); %>&nbsp;:</b></td>
	<td width="30%"><font size=2>
		<input type="radio" value="0" name="logcap" onClick='changelogstatus()' <% checkWrite("log-cap0"); %>><% multilang("Disable"); %>&nbsp;&nbsp;
		<input type="radio" value="1" name="logcap" onClick='changelogstatus()' <% checkWrite("log-cap1"); %>><% multilang("Enable"); %>
	</td>
</tr>    
<% ShowPPPSyslog("syslogppp"); %>		
<TBODY id='sysgroup'>
<tr>
	<td><font size=2><b><% multilang("Log Level"); %>&nbsp;:</b></td>
	<td><select name='levelLog' size="1">
		<% checkWrite("syslog-log"); %>
	</select></td>
</tr>
<tr>
	<td><font size=2><b><% multilang("Display Level"); %>&nbsp;:</b></td>
...
<tr>
	<td width="45%">	<input type="submit" value="<% multilang("Apply Changes"); %>" name="apply" onClick="return saveClick()"></td>
</tr>
   
<tr>
	<td width="25%"><font size=2><b><% multilang("Save Log to File"); %>:</b></td>
	<td width="30%"><font size=2><input type="submit" value="<% multilang("Save"); %>..." name="save_log"></td>
</tr>
<tr>
	<td width="25%"><font size=2><b><% multilang("Clear Log"); %>:</b></td>
	<td width="30%"><font size=2><input type="submit" value="<% multilang("Reset"); %>" name="clear_log"></td>
</tr>
</table>
<table border="0" cellspacing="4" width="500">
<tr><hr size=1 noshade align=top></tr>
