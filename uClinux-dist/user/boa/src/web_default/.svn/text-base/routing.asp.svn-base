...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang("Routing"); %><% multilang(" Configuration"); %></font></h2>

<form action=/boaform/formRouting method=POST name="route">
<table border=0 width="600" cellspacing=4 cellpadding=0>
  <tr><td><font size=2>
    <% multilang("This page is used to configure the routing information. Here you can add/delete IP routes."); %>
  </font></td></tr>
...
<table border=0 width="600" cellspacing=4 cellpadding=0>
  ...
  <input type="submit" value="<% multilang("Add Route"); %>" name="addRoute" onClick="return addClick()">&nbsp;&nbsp;
  <input type="submit" value="<% multilang("Update"); %>" name="updateRoute" onClick="return addClick()">&nbsp;&nbsp;
  <input type="submit" value="<% multilang("Delete Selected"); %>" name="delRoute" onClick="return deleteClick()">&nbsp;&nbsp;
  <input type="button" value="<% multilang("Show Routes"); %>" name="showRoute" onClick="routeClick('/routetbl.asp')">
<table border=0 width="600" cellspacing=4 cellpadding=0>
  <tr><td><hr size=1 noshade align=top></td></tr>
</table>
<table border=0 width="600" cellspacing=4 cellpadding=0>
  <tr><font size=2><b><% multilang("Static Route Table"); %>:</b></font></tr>
  <% showStaticRoute(); %>
</table>
  <br>
