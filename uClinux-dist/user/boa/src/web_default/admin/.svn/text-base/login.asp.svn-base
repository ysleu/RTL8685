          ...
          <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
            <TBODY>
              <TR vAlign=top>
                ...
                <TD vAlign=center width="71%"><FONT color=#0000FF size=2><% multilang("Input username and password"); %></FONT><BR><BR></TD>
	      </TR>
              <TR vAlign=top>
                <TD vAlign=center width="29%"><DIV align=right><FONT color=#0000FF size=2><% multilang("User"); %><% multilang(" Name"); %>:</FONT></DIV></TD>
                <TD vAlign=center width="5%"></TD>
                <TD vAlign=center width="71%"><FONT><INPUT maxLength=30 size=20 name=username></FONT></TD>
              </TR>
              <TR vAlign=top>
                <TD vAlign=center width="29%"><DIV align=right><FONT color=#0000FF size=2><% multilang("Password"); %>:</FONT></DIV></TD>
                <TD vAlign=center width="5%"></TD>
              ...
              <TR vAlign=top>
                ...
                <TD vAlign=center width="5%"></TD>
                <TD vAlign=center width="71%"><FONT size=2></FONT><BR><INPUT type=submit value="<% multilang("Login"); %>" name=save onClick=setpass()></TD>
