...
<title><% multilang("Differentiated Services"); %></title>
...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang("Differentiated Services"); %></font></h2>

<table border=0 width=600 cellspacing=4 cellpadding=0>
<tr><td colspan=4><font size=2>
 <% multilang("Entries in this table are used to assign the precedence for each incoming packet based on TCP/UDP port number, source/destination IP address/subnet masks."); %>
</font></td></tr>
...
<tr><td colspan=4><hr size=1 noshade align=top></td></tr>
<tr>
	<td><font size=2><b><% multilang("Differentiated Services"); %>:</b></td>
	<td><font size=2>
		<input type="radio" name=qoscap value=0 onClick="return adminClick()"><% multilang("Disabled"); %>&nbsp;&nbsp;
		<input type="radio" name=qoscap value=1 onClick="return adminClick()"><% multilang("Enabled"); %>
	</td>
</tr>
<TBODY id='diffservSetting'>
<tr>
	<td><font size=2><b><% multilang("PHB Groups"); %>:</b></td>
	...
	<td><font size=2><b><% multilang("Rate Limit"); %>:</b></td>
...
<tr>
	...
	<td></td>
	<td><font size=2><b><% multilang("Min"); %>:</b> 100Kb; <b><% multilang("Max"); %></b>: <% multilang("Total Bandwidth Limit"); %> - 100Kb</td>
</tr>
<tr>
	<td><font size=2><b><% multilang("Total Bandwidth Limit"); %>:</b></td>
	<td><font size=2><input type="text" name="totalbandwidth" size="6" maxlength="6" value="1024">Kb</td>
</tr>
<tr>
	<td><font size=2><b><% multilang("Max Desired Latency"); %>:</b></td>
...
<p><input type="submit" value="<% multilang("Apply Changes"); %>" name=addqos onClick="return addClick(this.form.phb)">
