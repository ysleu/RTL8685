...
<tr><td><font size=2><% multilang("Entries in this table are used for traffic control."); %></font></td></tr>
<tr><td colspan=4><hr size=1 noshade align=top></td></tr>
</table>

<p><% multilang("Total Bandwidth Limit"); %>:<input type="text" id="totalbandwidth" size="6" maxlength="6" value="1024">Kb</p>
...
<tr class="hdb" align="center" nowrap>
	...
	<td bgcolor="#808080"><% multilang("WAN Interface"); %></td>
	<td bgcolor="#808080"><% multilang("Protocol"); %></td>
	<td bgcolor="#808080"><% multilang("Source"); %> Port</td>
	<td bgcolor="#808080"><% multilang("Destination"); %> Port</td>
	<td bgcolor="#808080"><% multilang("Source"); %> IP</td>
	<td bgcolor="#808080"><% multilang("Destination"); %> IP</td>
	<td bgcolor="#808080"><% multilang("Rate"); %>(kb/s)</td>
	<td bgcolor="#808080"><% multilang("Delete"); %></td>
</tr>
</table>
...
<tr align="left">
<td>
	<input type="button" class="button" onClick="on_Add()" value="<% multilang("Add"); %>">
</td>
<td>
