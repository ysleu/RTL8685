...
<title>DoS<% multilang(" Configuration"); %></title>
...
<blockquote>
<h2><font color="#0000FF">DoS<% multilang(" Configuration"); %></font></h2>

<body>
<table border=0 width="500" cellspacing=0 cellpadding=0>
  <tr><td> <font size=2>
  <% multilang("DoS (Denial-of-Service) attack which is launched by hacker aims to prevent legal user from taking normal services. In this page you can configure to prevent some kinds of DOS attack."); %>
 </font><br></td></tr> 	
...
<form action=/boaform/admin/formDosCfg method=POST name="DosCfg">
  ...
  <tr><td width="200" ><font size=2><b><input type="checkbox" name="dosEnabled" value="ON" onclick="dosEnabledClick()">&nbsp;&nbsp;<% multilang("Enable DoS Block"); %></b></font></td></tr>
  <br>
  ...
  <tr><td width="60%">&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="UDPEchoChargenEnabled"   value="ON" > <font size=2><b> UDP EchoChargen </b></font></td></tr>
    ...
    <br>
    <input type="button" value="<% multilang("Select All"); %>" name="selectAll" onClick="SelectAll()">&nbsp;&nbsp;
    <input type="button" value="<% multilang("Clear"); %>" name="clearAll" onClick="ClearAll()">&nbsp;&nbsp;
    <br>
    <br>
  <table border="0" width=600>

  <tr><td width="60%">&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="sourceIPblock"  value="ON" > <font size=2><b> <% multilang("Enable Source IP Blocking"); %> </b></font></td>

   <td width="40%"><input type="text" name="IPblockTime" size="4" maxlength="3" value=<% getInfo("blockTime"); %> > <font size=2><b> <% multilang("Block Interval"); %> (<% multilang("seconds"); %>)</b></font><br></td></tr>

  </table>
  <br>
  <input type="submit" value="<% multilang("Apply Changes"); %>" name="enableDos" >&nbsp;&nbsp;
