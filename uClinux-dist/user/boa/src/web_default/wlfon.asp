...
<script>
  if (fon_onoffline == 0) {
	...
	<tr>
		<td><b><% multilang("Blocking between VAP"); %>:</b></td>
		<td><input type="radio" name="mbssid_block" value="disable" ><% multilang("Disable"); %>&nbsp;&nbsp;
		<input type="radio" name="mbssid_block" value="enable" ><% multilang("Enable"); %></td>
	</tr>
