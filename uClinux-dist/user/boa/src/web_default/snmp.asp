...
<title>SNMP <% multilang("Configuration"); %></title>
...
function saveChanges()
{
  ...
  if ( !checkDigitRange(document.snmpTable.snmpTrapIpAddr.value,1,0,223) ) {
      	alert('Invalid Trap IP address range in 1st digit. It should be 0-223.');
	document.snmpTable.snmpTrapIpAddr.value = document.snmpTable.snmpTrapIpAddr.defaultValue;
	document.snmpTable.snmpTrapIpAddr.focus();
	return false;
  }
...
<body>
<blockquote>
<h2><font color="#0000FF">SNMP <% multilang("Configuration"); %></font></h2>

<form action=/boaform/formSnmpConfig method=POST name="snmpTable">
<table border=0 width="500" cellspacing=4 cellpadding=0>
  <tr><td><font size=2>
    <% multilang("This page is used to configure the SNMP. Here you may change the settings for system description, trap ip address, community name, etc.."); %>
  </font></td></tr>
