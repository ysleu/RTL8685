...
function checkTextStr(obj)
{
	if(obj.value.length > 30){
		alert("length should less then 32!");
		obj.focus();
		return false;
	}
	...
	for (var i=0; i<obj.value.length; i++) 
	{
		...
		{
			alert("invalid character in text aera!");
			obj.focus();
			return false;
		}
	}
...
function setL2tpServer()
{
	...
	if (document.l2tp.peeraddr.value=="") {
		alert("Please enter peer start address!");
...
function addL2tpAccount()
{
	...
	if (document.l2tp.s_name.value=="") {
		alert("Please enter L2TP Server rule name!");
	...
	if(document.l2tp.s_tunnelAuth.checked){
		if(document.l2tp.s_authKey.value ==""){
			alert("Please enter l2tp tunnel authkey !");
	...
	{
		alert("Please enter l2tp Server username !");
	...
	if (document.l2tp.s_password.value=="") {
		alert("Please enter l2tp Server password!");
...
function addL2tpClient()
{
	...
	if (document.l2tp.c_name.value=="") {
		alert("Please enter L2TP client rule name!");
	...
	if (document.l2tp.mtu.value=="") {
                alert("Please enter L2TP client MTU!");
...
<table border=0 width="600" cellspacing=0 cellpadding=0>
  ...
  <tr>
    ...
    <td width="190" style="font-size:12px">
      <input type="radio" value="0" name="tunnelen"><% multilang("Disable"); %>&nbsp;&nbsp;
      <input type="radio" value="1" name="tunnelen" checked><% multilang("Enable"); %>
    </td>
  </tr>
...
<table border=0 width="600" cellspacing=2 cellpadding=0>
  ...
  <tr>
    ...
    <td align=center width="5%" bgcolor="#808080"><font size=2><% multilang("Enable"); %></font></td>
    <td align=center width="5%" bgcolor="#808080"><font size=2><% multilang("Username"); %></font></td>
    <td align=center width="8%" bgcolor="#808080"><font size=2><% multilang("Password"); %></font></td>
  </tr>
	<% l2tpServerList(); %>
  <tr>
  	<td colspan=7>
  	  <input type="submit" value="<% multilang("Delete Selected"); %>" name="delSelAccount">&nbsp;&nbsp;
	  <input type="submit" value="<% multilang("Save"); %>" name="saveAccount">
  	</td>
  </tr>
</table>
...
<table border=0 width="600" cellspacing=2 cellpadding=0>
  ...
  <tr>
    ...
    <td align=center width="5%" bgcolor="#808080"><font size=2><% multilang("tunnel Auth"); %></font></td>
    <td align=center width="5%" bgcolor="#808080"><font size=2><% multilang("PPP Auth"); %></font></td>
...
<input type="submit" value="<% multilang("Delete Selected"); %>" name="delSelClient">&nbsp;&nbsp;
