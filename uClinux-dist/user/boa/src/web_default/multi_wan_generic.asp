...
<title><%getWanIfDisplay();%> <% multilang("WAN"); %></title>
...
<BODY onLoad="on_init();">
<blockquote>
<h2><font color="#0000FF"><%getWanIfDisplay();%> <% multilang("WAN"); %></font></h2>
<form action=/boaform/admin/formWanEth method=POST name="ethwan">
<table border="0" cellspacing="4" width="800">
  <tr><td><font size=2>
    <% multilang("This page is used to configure the parameters for "); %> <%getWanIfDisplay();%> <% multilang("WAN of your Router."); %>
  </font></td></tr>
