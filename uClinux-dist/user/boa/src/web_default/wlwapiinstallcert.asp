...
<title>WAPI <% multilang("Certification Installation"); %></title>
<style>
.on {display:on}
.off {display:none}
</style>
...
<BODY>
<blockquote>
<h2><font color="#0000FF">WAPI <% multilang("Certification Installation"); %></font></h2>

<form method="post" action="/boaform/formUploadWapiCert1" enctype="multipart/form-data" name="uploadCert">
<table border="0" cellspacing="4" width="500">
 <tr><font size=2>
 <% multilang("This page allows you to install ASU and user certification for your Router. Please note, certification type X.509 is supported at present."); %>
 </tr>
 ...
 <!--
  ...
  -->
  <tr>
      <td width="20%"><font size=2><b>ASU <% multilang("Certification"); %>:</b>&nbsp;&nbsp;&nbsp;&nbsp;</td>
      <td width="80%"><font size=2><input type="file" value=<% multilang("Choose File"); %> name="asu_binary" size=20></td>
  </tr>
<!--  <tr>
...
-->
    ...
    <p> <input onclick=sendClicked(this.form) type=button value="<% multilang("Upload"); %>" name="send">&nbsp;&nbsp;    
...
-->
  <tr>
      <td width="20%"><font size=2><b>User <% multilang("Certification"); %>:</b>&nbsp;&nbsp;&nbsp;&nbsp;</td>
      <td width="80%"><font size=2><input type="file" value=<% multilang("Choose File"); %> name="user_binary" size=20></td>
  </tr>
  </table>
    <p> <input onclick=sendClicked(this.form) type=button value="<% multilang("Upload"); %>" name="send">&nbsp;&nbsp;
        <input type="reset" value="<% multilang("Reset"); %>" name="reset">
