...
void formDMZ(request * wp, char *path, char *query)
{
	...
	if (strSave[0]) {
		...
		if (vChar) {
			...
			if (v1) {
				if (v1 == v2) {
					strcpy(tmpBuf, "Invalid DMZ IP address!");
					goto setErr_dmz;
				}
				if ( (((v1 & v3) != (v2 & v3))
#ifdef SECONDARY_IP
		...
		if ( !mib_set(MIB_DMZ_ENABLE, (void *)&vChar)) {
			strcpy(tmpBuf, "Set DMZ Capability error!");
			goto setErr_dmz;
		}
	}
...
//	char extPort[8];
	...
	multilang("Select"), multilang("Comment"), multilang("Local"), multilang("IP Address"), multilang("Protocol"),
	multilang("Local Port"), multilang("Enable"),
	multilang("Remote Host"), multilang("Public Port"), multilang("Interface"));
...
int ipFwList(int eid, request * wp, int argc, char **argv)
{
	...
	multilang("External"), multilang("IP Address"));
...
int ipPortFilterList(int eid, request * wp, int argc, char **argv)
{
	...
	multilang("Select"), multilang("Direction"), multilang("Protocol"),
	multilang("Source"), multilang("IP Address"), multilang("Source Port"),
	multilang("Destination"), multilang("IP Address"), multilang("Destination Port"),
	multilang("Rule Action"));
	for (i=0; i<entryNum; i++) {
...
int macFilterList(int eid, request * wp, int argc, char **argv)
{
	...
	nBytesSent += boaWrite(wp, "<tr>"
		...
		"</tr>\n",
		multilang("Select"), multilang("Direction"), multilang("MAC Address"));
#else
	nBytesSent += boaWrite(wp, "<tr>"
		"<td align=center width=\"15%%\" bgcolor=\"#808080\"><font size=\"2\"><b>%s</b></font></td>\n"
		"<td align=center width=\"10%%\" bgcolor=\"#808080\"><font size=\"2\"><b>%s</b></font></td>\n"
		...
		"<td align=center width=\"30%%\" bgcolor=\"#808080\"><font size=\"2\"><b>%s %s</b></font></td>\n"
		"<td align=center width=\"15%%\" bgcolor=\"#808080\"><font size=\"2\"><b>%s</b></font></td></tr>\n",
		multilang("Select"), multilang("Direction"), multilang("Source"), multilang("MAC Address"),
		multilang("Destination"), multilang("MAC Address"), multilang("Rule Action"));
#endif
...
int nBytesSent=0;
	...
	"\r\n<td align=center width=\"6%%\" bgcolor=\"#808080\"><font size=\"2\"><b>%s</b></font></td>\n"
	"\r\n<td align=center width=\"6%%\" bgcolor=\"#808080\"><font size=\"2\"><b>%s</b></font></td>\n",
	multilang("Name"), multilang("MAC Address"), multilang("Sun"), multilang("Mon"),
	multilang("Tue"), multilang("Wed"), multilang("Thu"));
	...
	"\r\n<td align=center width=\"8%%\" bgcolor=\"#808080\"><font size=\"2\"><b>%s</b></font></td>\n"
      	"\r\n<td align=center width=\"7%%\" bgcolor=\"#808080\"><font size=\"2\"><b>%s</b></font></td></tr>\n", multilang("Fri"), multilang("Sat"), multilang("Start"),
	multilang("End"), multilang("Select"));
...
int showPFWAdvTable(int eid, request * wp, int argc, char **argv)
{
	...
	multilang("Select"), multilang("Category"), multilang("Interface"),
	multilang("LAN"), multilang("IP Address"), multilang("Rule"));
