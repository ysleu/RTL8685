...
int ifwanList(int eid, request * wp, int argc, char **argv)
{
	...
	unsigned char protocol = 0x3; // 1:IPv4, 2: IPv6, 3: Both. Mason Yu
	int hasVPN = 0;
	...
	if ( !strcmp(name, "all") )
		...
		{
			type = 1; hasAny = 1; hasVPN = 1; protocol = 0x1;
		}
	else if ( !strcmp(name, "rtv6-any-vpn") )
		{
			type = 1; hasAny = 1; hasVPN = 1; protocol = 0x2;
		}
#endif
