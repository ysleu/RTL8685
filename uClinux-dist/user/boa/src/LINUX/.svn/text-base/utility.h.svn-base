...
#else
#define ELANVIF_NUM 4//eth lan virtual interface number
#endif
#else
...
void route_cfg_modify(MIB_CE_IP_ROUTE_T *, int);
...
enum e_wan_mode {MODE_ATM = 1, MODE_Ethernet = 2, MODE_PTM = 4, MODE_BOND = 8, MODE_Wlan = 16};
int GetWanMode(void);
int isInterfaceMatch(unsigned int);
#define WAN_MODE_MASK (GET_MODE_ATM|GET_MODE_WLAN)

#ifdef CONFIG_DEV_xDSL
#define GET_MODE_ATM GET_MODE_ETHWAN|0x1
#else
#define GET_MODE_ATM GET_MODE_ETHWAN
#endif

#ifdef CONFIG_ETHWAN
#define GET_MODE_ETHWAN GET_MODE_PTM|0x2
#else
#define GET_MODE_ETHWAN GET_MODE_PTM
#endif

#ifdef CONFIG_PTMWAN
#define GET_MODE_PTM 0|0x4|GET_MODE_BOND
#else
...
struct thread_info {    				/* Used as argument to ddnsC() */
...
#endif
#define DNSRELAY_VC_START	0x60
#define DNSRELAY_NAS_START	0x70
#define DNSRELAY_PTM_START	0x80
#define DNSRELAY_PPP_START	0x90
