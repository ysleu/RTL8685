...
#define DUAL_WLAN_CHAIN_END_ID		DUAL_WLAN_CHAIN_START_ID+7
...
#define PON_ID						900
#define MIB_PON_MODE					PON_ID + 1
#if defined(CONFIG_GPON_FEATURE)
#define MIB_GPON_PASSWD					PON_ID + 2
#define MIB_GPON_SN					PON_ID + 3
#define MIB_GPON_LOID				PON_ID + 4
#endif
#if defined(CONFIG_EPON_FEATURE)
#define MIB_EPON_PASSWD				PON_ID + 5
#define MIB_EPON_LOID				PON_ID + 6
#endif
#if defined(CONFIG_GPON_FEATURE)
#define MIB_GPON_LOID_PASSWD		PON_ID + 7
#endif
#endif
...
/* Define your RS ID here, following are examples.*/
/*
#define MIB_RS_BYTE_TEST		RS_ENTRY_ID + 1
#define MIB_RS_WORD_TEST		RS_ENTRY_ID + 2
#define MIB_RS_DWORD_TEST		RS_ENTRY_ID + 3
#define MIB_RS_INT_TEST			RS_ENTRY_ID + 4
#define MIB_RS_STR_TEST			RS_ENTRY_ID + 5
#define MIB_RS_IP_TEST			RS_ENTRY_ID + 6
#define MIB_RS_IPV6_TEST		RS_ENTRY_ID + 7
*/
...
typedef enum { ACC_BRIDGED=0, ACC_MER, ACC_PPPOE, ACC_PPPOA, ACC_ROUTED, ACC_IPOA, ACC_DSLITE, ACC_6RD=8 } REMOTE_ACCESS_T;
...
typedef enum { IPv4 = 1, IPv6, IPv4_IPv6 } IP_PROTOCOL;
...
#if defined(CONFIG_GPON_FEATURE)
	unsigned char gpon_passwd[11];
	unsigned char gpon_sn[13];
	unsigned char gpon_loid[25];
	unsigned char gpon_loid_passwd[13];
#endif
#if defined(CONFIG_EPON_FEATURE)
	unsigned char epon_passwd[13];
	unsigned char epon_loid[25];
#endif
...
/* Define your own RS data here
	unsigned char byte_test;
	unsigned short word_test;
	unsigned int dword_test;
	int int_test;
	unsigned char str_test[8];
	unsigned char ip_test[IP_ADDR_LEN];
	unsigned char ip6_test[IP6_ADDR_LEN];
*/
} RS_MIB_T, *RS_MIB_Tp;
