...
#endif
#if !defined(CONFIG_RTK_VOIP_DRIVERS_PCM865xC) && !defined(CONFIG_RTK_VOIP_DRIVERS_PCM8972B_FAMILY) && !defined (CONFIG_RTK_VOIP_DRIVERS_PCM89xxC) &&!defined (CONFIG_RTK_VOIP_DRIVERS_PCM8672) &&!defined (CONFIG_RTK_VOIP_DRIVERS_PCM8676)/* !RTL8952/62 && !RTL8972B/82B && !RTL89xxC */
...
#endif
#ifndef CONFIG_RTK_VOIP_DRIVERS_SLIC_LE9662_NR		// 2s 
#define CONFIG_RTK_VOIP_DRIVERS_SLIC_LE9662_NR	0
#endif
#ifndef CONFIG_RTK_VOIP_DRIVERS_SLIC_LE88601_NR		// 2s
#define CONFIG_RTK_VOIP_DRIVERS_SLIC_LE88601_NR	0
#endif
...
#define SLIC_CH_NUM		( \
			...
			CONFIG_RTK_VOIP_DRIVERS_SLIC_LE9662_NR * 2 +	\
			CONFIG_RTK_VOIP_DRIVERS_SLIC_LE88601_NR * 2 + \
...
#if defined (CONFIG_RTK_VOIP_DRIVERS_PCM8972B_FAMILY) || defined (CONFIG_RTK_VOIP_DRIVERS_PCM8672) || defined (CONFIG_RTK_VOIP_DRIVERS_PCM89xxC) || defined (CONFIG_RTK_VOIP_DRIVERS_PCM8676)
