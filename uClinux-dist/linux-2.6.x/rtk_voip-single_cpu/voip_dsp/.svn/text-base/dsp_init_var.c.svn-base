...
uint32_t dtmf_data1[2/*dir*/][VOIP_CH_NUM*480] __attribute__((aligned(8)));
...
TstVoip_dtmf_det_data stVoip_dtmf_det_data[VOIP_CH_NUM][2];

extern void* pstVoip_dtmf_det[MAX_VOIP_CH_NUM][2];
