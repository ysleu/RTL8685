...
#if (__GNUC__ == 3) && (__GNUC_MINOR__ == 2) && (__GNUC_PATCHLEVEL__ == 3)//RDSK 1.2.8 B65
#define _DS_ "$"
#elif (__GNUC__ == 3) && (__GNUC_MINOR__ == 2)	//toolchain 0831
#define _DS_
#elif (__GNUC__ == 3) && (__GNUC_MINOR__ == 4) &&(__GNUC_PATCHLEVEL__ == 6)//RSDK 1.3.6 3.4.6
#define _DS_ "$"
#elif (__GNUC__ == 4) && (__GNUC_MINOR__ == 4)  //RSDK 1.5.4 4.4
#define _DS_ "$"
#else
#error "Toolcahin error. Need to define _DS_"
#endif
...
{
	ASM ("mtru %0, " _DS_ "mmd": /* no outputs */ : "d" ((long)(save)));
}
...
{
    long __result;
    ASM ("multa	" _DS_ "m0, %0, %1" : /* no outputs */ : "d" ((long)(a)), "d" ((long)(b)));
    ASM ("mfa	%0, " _DS_ "m0h" : "=d" (__result) : /* no inputs */);
    return __result;
}
...
{
	short __result;
	ASM ("multa2	" _DS_ "m1l, %0, %1" : /* no outputs */ : "d" ((short)(a)), "d" ((short)(b))); \
	ASM ("mfa	$15, " _DS_ "m1l" :/* no outputs */:/* no inputs */:"$15");	\
...
{
	ASM ("mta2	$0, " _DS_ "m0" : /* no outputs */ : /* no inputs */);
}
...
{
	ASM ("mta2	$0, " _DS_ "m1" : /* no outputs */ : /* no inputs */);
}
...
{
	ASM ("mta2	$0, " _DS_ "m2" : /* no outputs */ : /* no inputs */);
}
...
{
	ASM ("madda	" _DS_ "m0, %0,%0" : /* no outputs */ : "d" ((long)(a)));
}
...
{
	ASM ("madda	" _DS_ "m1, %0,%0" : /* no outputs */ : "d" ((long)(a)));
}
...
{
	ASM ("madda	" _DS_ "m2, %0,%0" : /* no outputs */ : "d" ((long)(a)));
}
...
{
	long __result;
	ASM ("mfa	%0, " _DS_ "m0l" : "=d" (__result) : /* no inputs */);
	return __result;
}
...
{
	long __result;
	ASM ("mfa	%0, " _DS_ "m1l" : "=d" (__result) : /* no inputs */);
	return __result;
}
...
{
	long __result;
	ASM ("mfa	%0, " _DS_ "m1h" : "=d" (__result) : /* no inputs */);
	return __result;
}
...
{
	long __result;
	ASM ("mfa	%0, " _DS_ "m2l" : "=d" (__result) : /* no inputs */);
	return __result;
}
...
{
	long __result;
	ASM ("mfa	%0, " _DS_ "m2h" : "=d" (__result) : /* no inputs */);
	return __result;
}
