...
int SetVoipResourceWeight(uint32 s_id, int pltype)
{
	if ((pltype == 0) || (pltype == 8))//G.711
		...
		else if ((pltype == rtpPayload_SPEEX_NB_RATE2P15) || (pltype == rtpPayload_SPEEX_NB_RATE5P95) || (pltype == rtpPayload_SPEEX_NB_RATE8) || (pltype == rtpPayload_SPEEX_NB_RATE11)
		      || (pltype == rtpPayload_SPEEX_NB_RATE15) || (pltype == rtpPayload_SPEEX_NB_RATE18P2) || (pltype == rtpPayload_SPEEX_NB_RATE24P6) || (pltype == rtpPayload_SPEEX_NB_RATE3P95))
