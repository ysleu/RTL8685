...
int do_mgr_VOIP_MGR_DEBUG( int cmd, void *user, unsigned int len, unsigned short seq_no )
{
	...
	extern void fft_acc_init(void);
	extern void fft_test( void );
	extern void fft_test2( void );
	extern void fft_test3( void );

	if (g_voip_debug == 73)
		fft_acc_init();
	else if (g_voip_debug == 74)
		fft_test();
	else if (g_voip_debug == 75)
		fft_test2();
	else if (g_voip_debug == 76)
		fft_test3();
