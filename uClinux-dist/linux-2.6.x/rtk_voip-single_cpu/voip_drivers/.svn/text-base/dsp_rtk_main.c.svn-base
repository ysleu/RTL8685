...
SampleRate_t VoipChannelSampleRate[ VOIP_CH_NUM ] = {[0 ... VOIP_CH_NUM-1] = SAMPLE_NARROW_BAND};
#endif
...
extern void isr_bus_rx_process( voip_dsp_t *this, uint16 *pcm_rx );
...
static voip_dsp_t dsp_rtk[ MAX_DSP_RTK_CH_NUM ];
...
int __init voip_dsp_rtk_register( void )
{
	...
	register_voip_dsp( &dsp_rtk[ 0 ], MAX_DSP_RTK_CH_NUM );
