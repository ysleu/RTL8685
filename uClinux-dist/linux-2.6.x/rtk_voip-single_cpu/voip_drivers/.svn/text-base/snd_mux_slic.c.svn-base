...
IMPLEMENT_TYPE1_void( Set_SLIC_Tx_Gain, unsigned char );
//void Set_SLIC_Rx_Gain( uint32 cch, unsigned char rx_gain )
IMPLEMENT_TYPE1_void( Set_SLIC_Rx_Gain, unsigned char );
...
void FXS_FXO_DTx_DRx_Loopback_greedy( uint32 cch, unsigned int enable )
{
	...
	voip_snd_t * const daa_snd = p_snd + 1;		// assume FXS/DAA instance is continual 
