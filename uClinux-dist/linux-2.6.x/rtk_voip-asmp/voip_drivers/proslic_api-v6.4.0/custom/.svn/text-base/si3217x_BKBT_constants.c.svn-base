...
** 2011-11-15 16:28:30
**
** Si3217x ProSLIC API Configuration Tool Version 2.9.0
*/
...
0x00F00000L,    /* DCDC_ANA_TONMAX */	//THLin: change DCDC_ANA_TONMAX from 0x800000 modify to 0xF00000 to fix REN issue
#else
