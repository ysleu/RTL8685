...
static void SLIC_Set_Ring_Cadence_proslic(voip_snd_t *this, unsigned short OnMsec, unsigned short OffMsec)
{
	...
	MultiRingCadenceEnable(chid, 0, 0, 0, 0, 0);

}

static void SLIC_Set_Multi_Ring_Cadence_proslic(voip_snd_t *this, unsigned short OnMsec1, unsigned short OffMsec1, unsigned short OnMsec2, unsigned short OffMsec2)
{
	ProslicContainer_t * const container = ( ProslicContainer_t * )this ->priv;
	proslicChanType * const pSlic = container ->ProObj;
	uint32 const chid = this->sch;
	...
	MultiRingCadenceEnable(chid, 1, OnMsec1, OffMsec1, OnMsec2, OffMsec2);
}
