...
static void SLIC_Set_Multi_Ring_Cadence_mirror_slic( voip_snd_t *this, unsigned short OnMsec1, unsigned short OffMsec1, unsigned short OnMsec2, unsigned short OffMsec2 )
{
	// Host will do this and forward to DSP 
