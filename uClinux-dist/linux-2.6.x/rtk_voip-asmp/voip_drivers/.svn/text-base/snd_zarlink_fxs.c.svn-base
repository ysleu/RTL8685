...
static void SLIC_Set_Multi_Ring_Cadence_zarlink(voip_snd_t *this, unsigned short OnMsec1, unsigned short OffMsec1, unsigned short OnMsec2, unsigned short OffMsec2)
{
	RTKLineObj * const pLine = (RTKLineObj * )this ->priv;
