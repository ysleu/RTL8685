...
{
	extern void MultiRingCadenceEnable_con(const voip_con_t *p_con, unsigned int enable, unsigned int on1, unsigned int off1, unsigned int on2, unsigned int off2);
	MultiRingCadenceEnable_con( get_voip_con_ptr( cch ), enable, on1, off1, on2, off2);
}
