...
int is_216pin_demo_board(void){
	*((volatile unsigned int *)0xbb010008) = 0xb0000000;
	if(*((volatile unsigned int *)0xbb010008) == 0xb000000b){
		return 1;
	}
	return 0;
}
...
{
	uint val;
	if(is_216pin_demo_board()){
		*((volatile unsigned int *)0xbb023020) = *((volatile unsigned int *)0xbb023020) & (~(0x28));
		*((volatile unsigned int *)0xbb000118) = *((volatile unsigned int *)0xbb000118) | (0x2);
	}
	else{
