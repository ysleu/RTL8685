...
* All rights reserved.
* 
* $Header: /usr/local/dslrepos/uClinux-dist/u-boot/u-boot-2011.12/arch/mips/cpu/rlx5281/rtl8686/rtk_soc/test/crypto/crypto/8672_asicregs.h,v 1.1 2012/08/07 02:58:32 krammer Exp $
*
* Abstract: ASIC specific definitions.
*
* $Author: krammer $
*
* $Log: 8672_asicregs.h,v $
...
#define PCRP6                               (0x01C+PCRAM_BASE)       /* Port Configuration Register of Port 6 */
#define PCRP7                               (0x020+PCRAM_BASE)       /* Port Configuration Register of Port 7 */
#define PCRP8                               (0x024+PCRAM_BASE)       /* Port Configuration Register of Port 8 */
