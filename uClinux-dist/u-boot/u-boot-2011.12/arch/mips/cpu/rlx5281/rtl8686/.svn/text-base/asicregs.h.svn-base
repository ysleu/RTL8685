...
* All rights reserved.
* 
* $Header: /usr/local/dslrepos/uClinux-dist/u-boot/u-boot-2011.12/arch/mips/cpu/rlx5281/rtl8686/asicregs.h,v 1.1 2012/08/07 02:58:32 krammer Exp $
*
...
#define cache_flush rlx5281_cache_flush_dcache
/* 
 * --------------------------------
 *      RTL865XC Platform
 * --------------------------------
