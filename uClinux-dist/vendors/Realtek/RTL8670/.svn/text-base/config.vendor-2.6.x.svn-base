...
#
# CONFIG_USER_FLATFSD_XXX is not set
...
# CONFIG_USER_AUTO_PROVISIONING is not set
CONFIG_USER_BOA_SRC_BOA=y
# CONFIG_USER_BOA_WITH_SSL is not set
CONFIG_DEFAULT_WEB=y
# CONFIG_GUI_WEB is not set
...
# CONFIG_USER_CWMP_TR069 is not set
CONFIG_USER_DDNS=y
...
# CONFIG_USER_SSH_DROPBEAR is not set
...
# CONFIG_USER_IPROUTE2_IP_IP is not set
...
# CONFIG_USER_NETLOGGER_SUPPORT is not set
# CONFIG_USER_OPENSSL_APPS is not set
# CONFIG_USER_PARENTAL_CONTROL is not set
...
# CONFIG_USER_PPPOE_PROXY is not set
...
# CONFIG_USER_REMOTE_MANAGEMENT is not set
...
# CONFIG_USER_SNMPD_SNMPD_V2C is not set
CONFIG_USER_SNMPD_SNMPD_V2CTRAP=y
...
# CONFIG_USER_BUSYBOX_BUSYBOX100PRE3 is not set
...
#
# CONFIG_USER_RTK_VOIP is not set
